...
namespace NOEXCEPT_BENCHMARK_LIB_NAME
{
  ...
  NOEXCEPT_BENCHMARK_SHARED_LIB_EXPORT double test_recursive_stack_unwinding_larger_func();
  ...
  NOEXCEPT_BENCHMARK_SHARED_LIB_EXPORT double test_explicitly_terminate_versus_noexcept();
