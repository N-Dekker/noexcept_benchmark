...
namespace NOEXCEPT_BENCHMARK_LIB_NAME
{
    ...
    NOEXCEPT_BENCHMARK_SHARED_LIB_EXPORT double test_inline_func_constexpr_false();
    NOEXCEPT_BENCHMARK_SHARED_LIB_EXPORT double test_inline_func_volatile_bool();
